        ...
        <div class="page-title-area item-bg3 jarallax" data-jarallax='{"speed": 0.3}'>
            <div class="container">
                <div class="page-title-content">
                    ...
                    <h2>Music, Dance & Drama Education</h2>
                </div>
            </div>
        </div>
        <!-- End Page Title Area -->
            ...
            <div class="container">
                <div class="myAccount-navigation">
                    <ul>
                        ...
                        <li><a href="/music" class="active"><i class='bx bx-download'></i> Music</a></li>
                ...
                <div class="myAccount-content">
                    <div class="col-lg-12">
                        <div class="article-content">
                          ...
                          <p>All pupils and Students have access to Music, Dance & Drama resources in all levels of Education cycle right from Nursery upto Tertiary level so that they can compete with the rest of the World in the Music Industry.</p>
                         </div>
                     </div>
                </div>
            </div>
