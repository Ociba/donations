        ...
        <div class="page-title-area item-bg1 jarallax" data-jarallax='{"speed": 0.3}'>
            <div class="container">
                <div class="page-title-content">
                    ...
                    <h2>Sports Science Education</h2>
                </div>
            </div>
        </div>
        <!-- End Page Title Area -->
            ...
            <div class="container">
                <div class="myAccount-navigation">
                    <ul>
                        ...
                        <li><a href="/computer"><i class='bx bx-cart'></i> Computer</a></li>
                        <li><a href="/music"><i class='bx bx-download'></i> Music</a></li>
                        <li><a href="/pe" class="active"><i class='bx bx-home-alt'></i> Physical Education</a></li>
                ...
                <div class="myAccount-content">
                    <div class="col-lg-12">
                        <div class="article-content">
                          <h3>Sports Science Education:</h3>
                          <p>All pupils and Students have access to Physical Education resources in all levels of Education cycle right from Nursery upto Tertiary level so that they can compete with the rest of the World in Sports.</p>
                         </div>
                     </div>
                </div>
            </div>
